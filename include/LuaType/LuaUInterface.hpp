#ifndef UE4SS_REWRITTEN_LUAUINTERFACE_HPP
#define UE4SS_REWRITTEN_LUAUINTERFACE_HPP
...
{
    struct UInterfaceName { constexpr static const char* ToString() { return "UInterface"; }};
...
#endif //UE4SS_REWRITTEN_LUAUINTERFACE_HPP
