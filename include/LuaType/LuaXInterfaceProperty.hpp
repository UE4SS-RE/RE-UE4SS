#ifndef UE4SS_REWRITTEN_LUAXINTERFACEPROPERTY_HPP
#define UE4SS_REWRITTEN_LUAXINTERFACEPROPERTY_HPP
...
{
    struct FInterfacePropertyName { constexpr static const char* ToString() { return "InterfaceProperty"; }};
...
#endif //UE4SS_REWRITTEN_LUAXINTERFACEPROPERTY_HPP
