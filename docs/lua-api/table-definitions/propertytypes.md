...
| DelegateProperty                 | internal_value |
| MulticastDelegateProperty        | internal_value |
| MulticastInlineDelegateProperty  | internal_value |
| MulticastSparseDelegateProperty  | internal_value |
