...
namespace RC::UVTD
{
    ...
    auto MemberVarsWrapperGenerator::generate_files() -> void
    {
        ...
        macro_setter_dumper.send(STR("        int32_t offset = static_cast<int32_t>(std::stoll(to_utf8_string(val_str), nullptr, 0));\n"));
        ...
        macro_setter_dumper.send(STR("            uint8_t bit_pos = static_cast<uint8_t>(std::stoll(to_utf8_string(val_str.substr(colon1 + 1))));\n"));
        ...
        macro_setter_dumper.send(STR("                bit_len = static_cast<uint8_t>(std::stoll(to_utf8_string(val_str.substr(colon2 + 1))));\n"));
        ...
        macro_setter_dumper.send(STR("                    storage_size = static_cast<uint8_t>(std::stoll(to_utf8_string(val_str.substr(colon3 + 1))));\n"));
        macro_setter_dumper.send(STR("                }\n"));
        macro_setter_dumper.send(STR("            }\n"));
