...
namespace RC::LuaType
{
    ...
    auto UDataTable::prepare_to_handle(const DataTableOperation operation, const LuaMadeSimple::Lua& lua) -> void
    {
        ...
        case DataTableOperation::FindRow: {
            ...
            std::string row_name_str(lua.get_string(1));
            Unreal::FName row_name(ensure_str(row_name_str).c_str(), Unreal::FNAME_Add);
        ...
        case DataTableOperation::AddRow: {
            ...
            std::string row_name_str(lua.get_string(1));
            Unreal::FName row_name(to_wstring(row_name_str).c_str(), Unreal::FNAME_Add);
        ...
        case DataTableOperation::GetAllRows: {
            ...
            lua_table.make_local();
            // Don't break here - let it fall through to return 1
            return; // This leaves the table on the stack for the return
        }
        }
    }
