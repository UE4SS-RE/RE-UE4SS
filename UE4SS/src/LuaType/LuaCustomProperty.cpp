...
namespace RC::LuaType
{
    ...
    auto LuaCustomProperty::PropertyList::add(SystemStringType property_name, std::unique_ptr<Unreal::CustomProperty> property) -> void
    {
    ...
    auto LuaCustomProperty::PropertyList::find_or_nullptr(Unreal::UObject* base, SystemStringType property_name) -> Unreal::FProperty*
    {
