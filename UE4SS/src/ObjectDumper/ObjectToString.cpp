...
namespace RC::ObjectDumper
{
    ...
    auto object_trivial_dump_to_string(void* p_this, SystemStringType& out_line, const SystemCharType* post_delimiter) -> void
    {
    ...
    auto property_trivial_dump_to_string(void* p_this, SystemStringType& out_line) -> void
    {
        ...
        out_line.append(std::format(SYSSTR("[n: {:X}] [c: {:016X}]"), p_typed_this->GetFName().GetComparisonIndex(), property_class.HashObject()));

        if (Version::IsAtLeast(4, 25))
        {
            out_line.append(std::format(SYSSTR(" [owr: {:016X}]"), p_typed_this->GetOwnerVariant().HashObject()));
        }
    }
    ...
    auto arrayproperty_to_string(void* p_this, SystemStringType& out_line) -> void
    {
        ...
        out_line.append(std::format(SYSSTR(" [ai: {:016X}]"), reinterpret_cast<uintptr_t>(p_typed_this->GetInner())));
    }
    ...
    auto classproperty_to_string(void* p_this, SystemStringType& out_line) -> void
    {
        ...
        property_trivial_dump_to_string(p_this, out_line);
        // mc = MetaClass
        out_line.append(std::format(SYSSTR(" [mc: {:016X}]"), reinterpret_cast<uintptr_t>(typed_this->GetMetaClass())));
    }
    ...
    auto delegateproperty_to_string(void* p_this, SystemStringType& out_line) -> void
    {
        ...
        out_line.append(std::format(SYSSTR(" [df: {:016X}]"), reinterpret_cast<uintptr_t>(p_typed_this->GetSignatureFunction())));
    }
    ...
    auto fieldpathproperty_to_string(void* p_this, SystemStringType& out_line) -> void
    {
        ...
        property_trivial_dump_to_string(p_this, out_line);
        out_line.append(std::format(SYSSTR(" [pc: {:016X}]"), reinterpret_cast<uintptr_t>(typed_this->GetPropertyClass())));
    }
    ...
    auto interfaceproperty_to_string(void* p_this, SystemStringType& out_line) -> void
    {
        ...
        property_trivial_dump_to_string(p_this, out_line);
        out_line.append(std::format(SYSSTR(" [ic: {:016X}]"), reinterpret_cast<uintptr_t>(typed_this->GetInterfaceClass())));
    }
    ...
    auto structproperty_to_string(void* p_this, SystemStringType& out_line) -> void
    {
        ...
        property_trivial_dump_to_string(p_this, out_line);
        out_line.append(std::format(SYSSTR(" [ss: {:016X}]"), reinterpret_cast<uintptr_t>(typed_this->GetStruct())));
    }
    ...
    auto enumproperty_to_string(void* p_this, SystemStringType& out_line) -> void
    {
        ...
        out_line.append(std::format(SYSSTR(" [em: {:016X}]"), reinterpret_cast<uintptr_t>(typed_this->GetEnum())));
    }
    ...
    auto boolproperty_to_string(void* p_this, SystemStringType& out_line) -> void
    {
        ...
        {
            out_line.append(std::format(SYSSTR(" [fm: {:X}] [bm: {:X}]"), typed_this->GetFieldMask(), typed_this->GetByteMask()));
        }
    }
    ...
    auto struct_to_string(void* p_this, SystemStringType& out_line) -> void
    {
        ...
        object_trivial_dump_to_string(p_this, out_line);
        out_line.append(std::format(SYSSTR(" [sps: {:016X}]"), reinterpret_cast<uintptr_t>(typed_this->GetSuperStruct())));
    }

    auto function_to_string(void* p_this, SystemStringType& out_line) -> void
    {
        object_trivial_dump_to_string(p_this, out_line, SYSSTR(":"));
    }
