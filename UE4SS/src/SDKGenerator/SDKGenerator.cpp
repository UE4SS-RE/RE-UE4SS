    ...
    class SDKGenerator
    {
      ...
      public:
        ...
        auto generate_dependency_requirements_for_property(FProperty* property, UStruct* struct_context) -> void
        {
            ...
            {
                UClass* interface_class = as_interface_property->GetInterfaceClass();
        ...
        auto generate_ufunction_params(UFunction* ufunction) -> void
        {
            ...
            // TODO(sdk-port): TFieldRange is not a std::ranges::input_range (TFieldIterator lacks the required
