...
namespace RC::UEGenerator
{
                                              ...
                                              bool generate_as_override) -> void
    {
        ...
        auto function_argument_list = generate_function_parameter_list(uclass, function, header_data, false, to_system_string(context_name), blacklisted_property_names);
