...
namespace RC::LuaType
{
    ...
    auto UScriptStruct::setup_member_functions(const LuaMadeSimple::Lua::Table& table, std::string_view metatable_name) -> void
    {
        ...
        table.add_pair("IsValid", [](const LuaMadeSimple::Lua& lua) -> int {
            ...
            if (lua_object.get_local_cpp_object().script_struct) { lua.set_bool(true); }
        ...
        table.add_pair("IsMappedToObject", [](const LuaMadeSimple::Lua& lua) -> int {
            ...
            if (lua_object.get_local_cpp_object().start_of_struct) { lua.set_bool(true); }
            else { lua.set_bool(false); }
        ...
        table.add_pair("IsMappedToProperty", [](const LuaMadeSimple::Lua& lua) -> int {
            ...
            if (lua_object.get_local_cpp_object().property) { lua.set_bool(true); }
            else { lua.set_bool(false); }
