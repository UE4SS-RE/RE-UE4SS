...
// Prefix emitters
#define EVM_ENUM_PREFIX_CASE(EnumName, v)  case E##EnumName::v: return "(" EVM_STRINGIZE(v) ") ";
...
#define EVM_ENUM_PREFIX_CASE_V(EnumName, v, val)  case E##EnumName::v: return "(" EVM_STRINGIZE(v) ") ";
