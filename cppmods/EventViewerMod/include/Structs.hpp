...
namespace RC::EventViewerMod
{
    ...
    struct CallStackEntry : EntryBase, AllNameStringViews
    {
        ...
        CallStackEntry(EMiddlewareHookTarget hook_target, const AllNameStringViews& strings, uint32_t depth,
                       std::thread::id thread_id, bool is_tick);

        auto render(int indent_delta,
                    ECallStackEntryRenderFlags_ flags = ECallStackEntryRenderFlags_None) const -> void;
