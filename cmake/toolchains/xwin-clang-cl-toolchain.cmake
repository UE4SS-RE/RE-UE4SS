...
set(SYSTEM_INCLUDE_FLAGS "/external:I${XWIN_CACHE_DIR}/crt/include /external:I${XWIN_CACHE_DIR}/sdk/include/ucrt /external:I${XWIN_CACHE_DIR}/sdk/include/shared /external:I${XWIN_CACHE_DIR}/sdk/include/um /external:I${XWIN_CACHE_DIR}/sdk/include/winrt /external:W0")
...
# C++ flags - just the essentials for cross-compilation
set(CMAKE_CXX_FLAGS_INIT "-vctoolsdir=${XWIN_CACHE_DIR}/crt -winsdkdir=${XWIN_CACHE_DIR}/sdk ${SYSTEM_INCLUDE_FLAGS}")
...
if(DEFINED ENV{HOME})
    set(Rust_CARGO "$ENV{HOME}/.cargo/bin/cargo-xwin" CACHE FILEPATH "" FORCE)
endif()
